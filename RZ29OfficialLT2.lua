local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/bisalahanjg/boyxd/main/SubscribeRZ29Official.lua"))()
local RZ29Official = library.new("RZ29Official", 5013109572)

game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "RZ29 Official";
    Text = "Welcome "..game.Players.LocalPlayer.Name
})
if game:GetService("StarterGui") then  game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Subscribe RZ29 Official", "All")
end
...
game.Players.ChildAdded:Connect(function(player)
    ...
    SendNotification("RZ29 Official",""..player.Name.." has JOINED the game",7 )
    end) then
      print ("Error")
    end
end)
game.Players.ChildRemoved:Connect(function(player)
    if not pcall (function()
    SendNotification("RZ29 Official",""..player.Name.." has LEFT the game",6 )
    end) then
      print ("Error")
    end
end)
    
    SendNotification("RZ29 Official","Join and leave Loaded",5)
...
--page pertama
local page1 = RZ29Official:addPage("Home", 4595286933)
...
section1:addButton("Send Message", function()
    game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Subscribe RZ29 Official", "All")
end)


section2:addButton("RZ29 Official", function()
...
section2:addButton("Subscribe RZ29 Official", function()
    setclipboard("www.youtube.com/channel/UC2E1RxNimBPqfzNWfFoCptA")
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "RZ29 Official";
...
section3:addButton("Destroy Gui", function()
        game:GetService("CoreGui").RZ29Official:Destroy()
end)
...
-- page kedua [ tema ]
local page2 = RZ29Official:addPage("Tema", 5028857084)
local colors = page2:addSection("Colors")

for theme, color in pairs(themes) do
colors:addColorPicker(theme, color, function(color3)
RZ29Official:setTheme(theme, color3)
end)
end

-- load pertama kali buka script
RZ29Official:SelectPage(RZ29Official.pages[1], true)

-- page ketiga
local page4 = RZ29Official:addPage("Player", 5012544693)
...
superman:addButton("Infinity Jump", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/bisalahanjg/boyxd/main/infinity-jump.txt"))()
end)
...
-- page keempat
local item = RZ29Official:addPage("Base", 5012544693)
local baseglitch = item:addSection("Base Glitch")
local itembase = item:addSection("Car")

baseglitch:addButton("Free Land", function()
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/bisalahanjg/boyxd/main/free-land.txt"))()
end)
...
itembase:addButton("Car Colour Tool", function()
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/bisalahanjg/boyxd/main/PINK-CAR-SPAWNER.txt"))()
end)

-- page kelima
local kayu = RZ29Official:addPage("Wood", 5012544693)
...
--Page Keenam
local page3 = RZ29Official:addPage("World", 5012544693)
...
informents:addButton("Full Bright", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/bisalahanjg/boyxd/main/Full-Bright.txt", true))();
...
betul:addButton("B Tools", function()
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/bisalahanjg/boyxd/main/b-tools.txt"))()
end)

-- Page KeTujuh
local Duper = RZ29Official:addPage("Dupe", 5012544693)
...
--Page keDelapan
local AnotherGUI = RZ29Official:addPage("RZ29 HUB", 5012544693)
...
Script:addToggle("Dupe Axe", nil, function(state)
    if state == true then
        loadstring(game:HttpGet('https://raw.githubusercontent.com/bisalahanjg/boyxd/main/axe_dupe_v.4.3_lt2.txt'))()
    end
    if state == false then
...
Script:addToggle("New Money Dupe", nil, function(state)
    if state == true then
        loadstring(game:HttpGet("https://raw.githubusercontent.com/bisalahanjg/boyxd/main/RZ29OfficialMoney.lua"))()
    end
    if state == false then
...
Gui:addToggle("Blood Gui V4", nil, function(state)
   if state == true then
        loadstring(game:HttpGet("https://raw.githubusercontent.com/bisalahanjg/boyxd/main/BloodV4gU1-obfuscated.lua"))()
   end
   if state == false then
...
Gui:addToggle("Bark GUI", nil, function(state)
    if state == true then
        loadstring(game:HttpGet("https://raw.githubusercontent.com/bisalahanjg/boyxd/main/bark.txt"))()
    end
    if state == false then
        SendNotification("RZ29 Official", "Bark GUI Can't Be Deleted")
    end
end)

-- Page Kesembilan
local SpecialThanks = RZ29Official:addPage("Special Thanks")
local Owner = SpecialThanks:addSection("RZ29 Official - Showcase")
...
local Owner5 = SpecialThanks:addSection("RZ29 Official")



--script dimatikan ?
local CloseScript = game:GetService("CoreGui").ChildRemoved:Connect(function(child)
    if child.Name == "RZ29 Official" then
        lari:Disconnect()
    end
    if child.Name == "RZ29 Official" then
